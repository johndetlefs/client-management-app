 ...
 */
export async function getClients(tenantId: string): Promise<ActionResult<Client[]>> {
    try {
 ...
 */
export async function getClient(tenantId: string, clientId: string): Promise<ActionResult<Client>> {
    try {
