...
2. Check `.project-workflow/TRACKER.md` for an existing row with the same title or obvious duplicate scope. If present, stop and ask whether to reuse the existing task.
...
6. Continue to requirements capture when the user is ready.
